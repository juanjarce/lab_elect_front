...
const ProductoDetalleModal = ({ producto, id, onClose }) => {
    ...
    const obtenerCantidadDisponible = async () => {
      ...
      try {
        const response = await axios.get(
          `https://labuq.catavento.co:10444/api/estudiantes/productos/${producto.id}/cantidad-disponible`,
        );
  ...
  const handleAgregarCarrito = async () => {
    ...
    try {
      await axios.post(
        `https://labuq.catavento.co:10444/api/estudiantes/producto/agregar/${id}/${producto.id}?cantidad=${cantidadSeleccionada}`,
        null,
        {
