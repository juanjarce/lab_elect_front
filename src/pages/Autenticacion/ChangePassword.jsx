  ...
  const sendVerificationCode = async () => {
    ...
    try {
      const idResponse = await fetch(
        `https://labuq.catavento.co/services/api/estudiantes/id-by-email?email=${formData.email}`,
      );
      if (!idResponse.ok) {
      ...
      await fetch(
        `https://labuq.catavento.co/services/api/autenticacion/enviar-verificacion/${estudianteId}`,
        { method: "POST" },
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://labuq.catavento.co/services/api/autenticacion/cambiar-contraseña/${estudianteId}`,
        {
          method: "PUT",
          headers: {
