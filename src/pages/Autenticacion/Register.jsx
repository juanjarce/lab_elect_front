  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const registerResponse = await fetch(
        "https://labuq.catavento.co/services/api/autenticacion/registrar-estudiante",
        {
          method: "POST",
      ...
      const idResponse = await fetch(
        `https://labuq.catavento.co/services/api/estudiantes/id?cedula=${formData.cedula}`,
      );
      if (!idResponse.ok) {
      ...
      const verifyResponse = await fetch(
        `https://labuq.catavento.co/services/api/autenticacion/enviar-verificacion/${id}`,
        {
          method: "POST",
        },
      );
