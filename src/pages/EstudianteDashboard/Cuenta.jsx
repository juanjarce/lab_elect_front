...
const Cuenta = () => {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`https://labuq.catavento.co/services/api/estudiantes/informacion-cuenta/${id}`, {
        headers: {
  ...
  const handleUpdateAccount = async () => {
    ...
    try {
      const response = await axios.put(
        `https://labuq.catavento.co/services/api/estudiantes/actualizar/${id}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://labuq.catavento.co/services/api/estudiantes/eliminar/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
