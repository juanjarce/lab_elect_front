  ...
  const cargarProductos = async (page) => {
    ...
    try {
      const response = await axios.get(
        `https://labuq.catavento.co/services/api/estudiantes/productos/filtrados?page=${page}&size=${pageSize}&nombre=${searchNombre}&categoria=${searchCategoria}&ubicacion=${ubicacion}`,
