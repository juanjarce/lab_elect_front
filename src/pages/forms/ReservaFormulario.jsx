...
const ReservaFormulario = ({ show, onClose, laboratorio }) => {
  ...
  const cargarAgenda = async () => {
    ...
    try {
      const response = await axios.get(
        `https://labuq.catavento.co/services/api/admin/agenda/${laboratorio.id}/${fecha}`,
        {
  ...
  /**
   * handles the selection of an agenda
   * @param {*} agenda
   */
  ...
  /**
   * handles the creation of the agenda
   * @returns
   */
  const handleCrearAgenda = async () => {
    ...
    try {
      const response = await axios.post(
        "https://labuq.catavento.co/services/api/admin/agenda/crear",
        {
