  ...
  const fetchPrestamos = async (page = 0, searchQuery = "") => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://labuq.catavento.co:10444/api/admin/prestamos/prestados?page=${page}&size=99&search=${searchQuery}`,
        {
          headers: {
  ...
  const handleEntregaPrestamo = async (idPrestamo) => {
    try {
      ...
      const response = await axios.put(
        `https://labuq.catavento.co:10444/api/admin/prestamos/devolver/${idPrestamo}/${id}`,
        null,
        {
          headers: {
            Authorization: `Bearer ${token}`,
