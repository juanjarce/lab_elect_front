  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const registerResponse = await fetch(
        "https://labuq.catavento.co:10444/api/autenticacion/registrar-estudiante",
        {
          method: "POST",
      ...
      const idResponse = await fetch(
        `https://labuq.catavento.co:10444/api/estudiantes/id?cedula=${formData.cedula}`,
      );
      if (!idResponse.ok) {
      ...
      const verifyResponse = await fetch(
        `https://labuq.catavento.co:10444/api/autenticacion/enviar-verificacion/${id}`,
        {
          method: "POST",
        },
      );
