...
const Productos = () => {
  ...
  const cargarProductos = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://labuq.catavento.co:10444/api/admin/productos/filtrados?page=${currentPage}&size=${pageSize}&nombre=${searchNombre}&categoria=${searchCategoria}&ubicacion=${ubicacion}`,
        {
          headers: {
  ...
  const eliminarProducto = async () => {
    ...
    try {
      ...
      await axios.delete(
        `https://labuq.catavento.co:10444/api/admin/productos/eliminar/${productoAEliminar.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
